...
<div class="content">
    <div class="wrap">
        <form action="userpicture.php" method="post" enctype="multipart/form-data">
            ...
            <div class="account">
                <div class="account-title">上传动态</div>
                <div class="tsm-box">
                    <div class="tsm-title">个人资料
                    </div>
                    <div class="tsm-a" style="display:block;">
                        <div class="tsm-a1">
                            <div class="tsm-a2 fl">动态图片：</div>
                            <div class="tsm-a3"><input name="myFile" type="file" class="tsm-text1"></div>
                        </div>

                        <div class="tsm-a1">
                            <div class="tsm-a2 fl">动态信息：</div>
                            <div class="tsm-a3"><input name="title" type="text" class="tsm-text1"></div>
                        </div>

                        <div class="tsm-a1">
                            <div class="tsm-a2 fl">心情：</div>
                            <div class="tsm-a3"><input name="message" type="text"  class="tsm-text1"><br></div>
                        </div>
                        <div class="tsm-a1">
                            <div class="tsm-a3"><input type="hidden" name="MAX_FILE_SIZE" value="5120" class="tsm-text1"></div>
                        </div>
                    </div>
                </div>
                <div class="tsm-href"><input type="submit" value="上传" name="save" id="sub" /></div>
            </div>
        </form>
    </div>
</div>
